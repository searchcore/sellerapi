...
from src.application.common.interfaces import IUoW, IPurchaseTokenProvider, IValidatorProvider

from src.infrastructure.implementations.common import UoW, PurchaseTokenProvider, ValidatorProvider
